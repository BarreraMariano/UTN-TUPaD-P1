...
listaVacia.append("casa")
listaVacia.append("chau")
...
# Remueve el volar mas alto de la lista utilizando la funcion remove para eliminar y max para obtener el valor maximo
